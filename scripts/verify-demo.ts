...
async function runVerification() {
  ...
  try {
    ...
    try {
      ...
      console.warn('  ⚠️ Server offline or unreachable at http://localhost:5000. (Mocking endpoint validation logic)');
    }
    ...
    console.log('  Registering Donor Payload:', donorPayload);
    ...
    console.log('  Registering Recipient Payload:', recipientPayload);
